...
<tbody>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="listtable"><th hidden><?php echo ($vo['id']); ?></th><td><?php echo ($vo['customername']); ?></td><td><?php echo ($vo['customerphone']); ?></td><td><?php echo ($vo['status']); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
</tbody>
</table>
</div>
<!-- Large modal -->
